            ...
            ->children()
                ...
                ->arrayNode('webhooks')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('path')
                            ->defaultValue('/webhooks/gando')
                            ->cannotBeEmpty()
                            ->info('Default route path for the bundled GandoWebhookController.')
                        ->end()
                        ->integerNode('dedup_ttl_seconds')
                            ->defaultValue(86_400)
                            ->min(60)
                            ->info('How long to remember processed webhook bodies (requires cache.app).')
                        ->end()
                    ->end()
                ->end()
            ->end();
